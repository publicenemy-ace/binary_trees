...
/**
 * tree_is_complete - verifies if tree is complete
...
/**
 * check_parent - verifies if parent has a greater value than its childs
...
/**
 * binary_tree_is_heap - verifies if an input tree is a Max Binary Heap
