...
/**
 * binary_tree_is_leaf - verifies if a node is a leaf
...
/**
 * binary_tree_height - determines height of a binary tree
 * @tree: pointer to root node of the tree to determine the height of
 ...
 * @tree: pointer to root node of the tree to verify
